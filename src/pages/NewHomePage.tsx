...
import AntFooter from "../components/layout/NewAntFooter";
      ...
      <Content className="site-content">
            ...
            <Row gutter={[48, 48]} align="middle">
              <Col xs={24} lg={12} className="order-lg-2">
                ...
                >
                  ...
                  <Paragraph className="section-description">
                    ArtisanLink is more than a marketplace. We're a movement to
                    preserve cultural heritage, promote sustainable practices,
                    and create economic opportunities for artisans worldwide.
                  </Paragraph>
        ...
        <div className="stories-section">
          <div className="content-wrapper">
            ...
            <div className="text-center mt-40">
              <Button type="default" size="large" className="secondary-button">
          ...
          <div className="content-wrapper">
            ...
            >
              ...
              <Space size="large" className="cta-buttons">
                ...
                <Button size="large" className="cta-button-white">
